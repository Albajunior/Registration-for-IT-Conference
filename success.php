<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($isSuccess){
            //$sendmail_response = SendEmail::SendMail($email, 'Welcome to IT Conference 2019', 'You have successfully registerted for this year\'s IT Conference');
            //echo "sendmail response "+$sendmail_response;
            include 'includes/successmessage.php';
            //echo "Operation has been completed";
        }
        else{
            include 'includes/errormessage.php';
            //echo "Operation has uncompleted";
        }
